...
const Order = ({ orderFormValue, cartItems, selectedCurrency, clearCart }) => {
    ...
    useEffect(() => {
        document.title = "Order summary | Womens Fashion";
    }, []);
    ...
    return (
        <main className="order">
            ...
            <section className="order-success">
                ...
                <p>
                    Your order has been received successfully at Womens Fashion . We're thrilled that you've chosen us for your fashion needs. Your style journey is about to begin!
                </p>
                <h3> Order Details:</h3>
                <ul className="order-details">
                    ...
                    <li>Payment Method: Card Payment</li>
                </ul>
                <h3>Items Ordered:</h3>
